...
def Program_screen():
    ...
    while True:
        ...
        if start == 0:
            ...
            cvzone.putTextRect(img, 'Press S to start', (480, 500), scale=2, thickness=2, colorT=(255, 255, 255), colorR=False, offset=20)
            cvzone.putTextRect(img, 'HOW TO PLAY', (490, 50), scale=3, thickness=2, colorT=(255, 255, 255), colorR=(255, 0, 0), offset=20)
            cvzone.putTextRect(img, '1. Put your hand in the circle', (300, 90), scale=1.5, thickness=2, colorT=(255, 255, 255), colorR=(255, 0, 0), offset=20)
            cvzone.putTextRect(img, '2. Push it toward as a push button action', (300, 140), scale=1.5, thickness=2, colorT=(255, 255, 255), colorR=(255, 0, 0), offset=20)
...
Btn = tk.Button(interface, text='Go to program', font=("Times New Roman", 20, "bold"), bg="skyblue", fg='black', command=Program_screen)
